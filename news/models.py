...
class News(TimeStampedModel):
    ...
    picture = models.ForeignKey(Image, verbose_name=_('Picture'), related_name='+', blank=True,
                                null=True, on_delete=models.SET_NULL)
    post = models.ForeignKey('blog.BlogPost', verbose_name=_('Post'), blank=True, null=True, on_delete=models.SET_NULL,
