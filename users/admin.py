...
class StudentCardAdmin(ModelAdmin):
    ...
    ordering = ('student__user__last_name', 'student__user__first_name', 'student__user__patronymic')
...
class TeacherAdmin(ModelAdmin):
    ...
    ordering = ('user__last_name', 'user__first_name', 'user__patronymic', 'groups__name', 'subjects__name')
...
class UsersGroupAdmin(ModelAdminGroup):
    ...
    items = (StudentAdmin, StudentCardAdmin, EntrantAdmin, TeacherAdmin, UserDocumentAdmin)
