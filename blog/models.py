...
class BlogPostCategory(models.Model):
    ...
    slug = models.SlugField(_('Slug'), allow_unicode=True, max_length=255, help_text=_('Blog Post identifier'))
...
class BlogPostTag(TaggedItemBase):
    content_object = ParentalKey('blog.BlogPost', verbose_name=_('Blog Post'), related_name='tagged_posts')


class BlogPost(ClusterableModel, TimeStampedModel):
    author = models.ForeignKey('authentication.User', verbose_name=_('Author'), on_delete=models.SET_NULL, null=True,
                               blank=True,
