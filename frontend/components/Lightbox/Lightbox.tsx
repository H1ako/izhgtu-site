...
function Lightbox() {
  ...
  return (
    <ModalAreaLayout isActive={!!lightboxImageSrc.length} className={styles.lightbox} onClose={closeLightbox}>
      <div className={styles.lightbox__control}>
        <button className={styles.control__btn} onClick={rotateImage}>
          <FontAwesomeIcon icon={faRotate} />
        </button>
      </div>
      <img ref={imageRef} src={lightboxImageSrc} alt="" className={styles.lightbox__image}/>
    </ModalAreaLayout>
  )
}
